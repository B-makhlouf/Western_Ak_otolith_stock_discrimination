...
Modelname<- paste("Rf_Sr8786_", paste(landmark_filter, collapse = "_"), ".rds", sep = "")
...
Modelname<- paste("SVM_Sr8786_", paste(landmark_filter, collapse = "_"), ".rds", sep = "")
...
filename <- paste("/Users/benjaminmakhlouf/Research_repos/Western_Ak_otolith_stock_discrimination/Model Results/Sr8786_",paste0(landmark_filter, collapse = "_"),"MultiModel_Results",  ".csv", sep = "")
...
landmark_title <- paste( paste(landmark_filter, collapse = "_"), ",Sr8786")
